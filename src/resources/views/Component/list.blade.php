                                            ...
                                            <tr class="gradeX">
                                               ...
                                               <td>
                                                    <div class="tpl-table-black-operation">
                                                    	<a href="{{ asset('/component/eventlist')}}/{{$component->id}}">
                                                            <i class="am-icon-pencil"></i> 事件列表
                                                        </a>
                                                    	<a href="{{ asset('/component/info')}}/{{$component->id}}">
                                                            <i class="am-icon-pencil"></i> 详情
                                                        </a>
                                                        <a href="{{ asset('/authority/complist')}}/{{$component->id}}">
