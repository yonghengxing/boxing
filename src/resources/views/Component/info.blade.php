                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                 ...
                                 <form class="am-form tpl-form-border-form  tpl-form-border-br" action="{{ asset('/component/info')}}/{{$component->id}}" method="post" onsubmit="return checkForm()">
									<input type="hidden" name="_token" value="{{ csrf_token() }}" />
									<div class="am-form-group">
                                        <label  class="am-u-sm-3 am-form-label">组件名称<span class="tpl-form-line-small-title">  User Name</span></label>
                                        <div class="am-u-sm-9">
                                             <input type="text" class="tpl-form-input" id="comp_name"  name="comp_name" placeholder="请输入组件的名称" value="{{$component->comp_name}}">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
										...
										<div class="am-u-sm-9">
											...
											placeholder="请输入组件描述">{{$component->comp_desc}}</textarea>
											<small></small>
										</div>
									</div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                          @foreach(config('app.comp_type') as $id=> $type)
                                         	...
                                         	@if($id == $component->comp_type)
                                              <input type="radio" id="comp_type" name="comp_type" value="{{ $id }}" data-am-ucheck checked>{{ $type}}
                                            @else
                                        ...
                                        <div class="am-u-sm-9">
                                            <select data-am-selected="{searchBox: 1}" style="display: none;" id="group_id" name="group_id">
                                            	@foreach($groups as $id=> $group)
                                            		@if($group->id == $component->group_id)
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-12 am-u-sm-push-12">
                                            <button type="submit" class="am-btn am-btn-primary tpl-btn-bg-color-success ">编辑</button>
                                        </div>
                                    </div>
