		...
		<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
			<div class="widget am-cf">
				<div class="widget-head am-cf">
					<div class="widget-title am-fl">为组件 {{$component->comp_name}} 增加可访问的开发方用户</div>
				...
				<div class="widget-body am-fr">
					<form class="am-form tpl-form-border-form  tpl-form-border-br"
						action="{{ asset('authority/adddever')}}/{{$component->id}}/{{$pro_id}}" method="post"
						enctype="multipart/form-data">
							...
							<div class="widget-body am-fr" id="showUser">
								<div class="am-form-group" index="1" id="user1">
									<label class="am-u-sm-3 am-form-label">开发方用户(1)</label>
									<div class="am-u-sm-9">
										...
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<button type="button"
													...
													onclick="addUser();">
													<span class="am-icon-plus"></span> 追加开发方用户
												</button>
												<button type="button"
													class="am-btn am-btn-default am-btn-danger"
													onclick="deleteUser();">
													<span class="am-icon-trash-o"></span> 删除开发方用户
												</button>
											</div>
										</div>
									</div>
								...
								function addUser()
 								{
									...
									var str = '<div class="am-form-group" index="'+
									 userIndex + '" id="user'+
									 userIndex + '"><label class="am-u-sm-3 am-form-label">开发方用户('+
