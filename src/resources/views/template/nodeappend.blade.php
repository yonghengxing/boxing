			...
			<div class="widget am-cf">
				...
				<div class="widget-body am-fr">
					<form class="am-form tpl-form-border-form  tpl-form-border-br"
						action="{{ asset('template/nodeappend')}}/{{$node->id}}" method="post"
						enctype="multipart/form-data">
							...
							<div class="widget-body am-fr" id="showApprover">
								<div class="am-form-group" index="1" id="approver1">
									<label class="am-u-sm-3 am-form-label">机关(1)</label>
									<div class="am-u-sm-9">
										...
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<button type="button"
													...
													onclick="addApprover();">
													<span class="am-icon-plus"></span> 追加机关用户
												</button>
												<button type="button"
													class="am-btn am-btn-default am-btn-danger"
													onclick="deleteApprover();">
													<span class="am-icon-trash-o"></span> 删除机关用户
												</button>
											</div>
										</div>
									</div>
								...
								function addApprover()
 								{
									...
									approverIndex + '"><label class="am-u-sm-3 am-form-label">机关('+
