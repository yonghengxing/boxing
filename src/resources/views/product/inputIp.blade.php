        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                            ...
                            <form class="am-form tpl-form-line-form"  action="{{ asset('/product/sendToEqu')}}" method="post" >
                                ...
                                <div class="am-form-group am-form-success am-form-icon am-form-feedback" style="margin-top:50px;margin-bottom:20px;">
                                    ...
                                    <div class="am-u-sm-10">
                                        <input type="text" id="doc-ipt-3-a" class="am-form-field" name="ip" placeholder="输入设备IP，推送产品文件到设备" value="{{$ip}}">
                                ...
                                <div class="am-form-group" >
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button type="submit" class="am-btn am-btn-primary tpl-btn-bg-color-success ">推送</button>
                                    </div>
                                </div>
                            </form>
